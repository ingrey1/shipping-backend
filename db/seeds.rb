...
#  (1, N'Davolio', N'Nancy', N'Sales Representative', N'Ms.', CAST(N'1966-12-08T00:00:00.000' AS DateTime],, CAST(N'2010-05-01T00:00:00.000' AS DateTime],, N'507 - 20th Ave. E.
...
#  (5, N'Buchanan', N'Steven', N'Sales Manager', N'Mr.', CAST(N'1973-03-04T00:00:00.000' AS DateTime],, CAST(N'2011-10-17T00:00:00.000' AS DateTime],, N'14 Garrett Hill', N'London', NULL, N'SW1 8JR', N'UK', N'(71], 555-4848', N'3453', N'Steven Buchanan graduated from St. Andrews University, Scotland, with a BSC degree in 1976.  Upon joining the company as a sales representative in 1992, he spent 6 months in an orientation program at the Seattle office and then returned to his permanent post in London.  He was promoted to sales manager in March 1993.  Mr. Buchanan has completed the courses "Successful Telemarketing" and "International Sales Management."  He is fluent in French.', 2, N'http://accweb/emmployees/buchanan.bmp'],
...
#  (6, N'Suyama', N'Michael', N'Sales Representative', N'Mr.', CAST(N'1981-07-02T00:00:00.000' AS DateTime],, CAST(N'2011-10-17T00:00:00.000' AS DateTime],, N'Coventry House
...
# (7, N'King', N'Robert', N'Sales Representative', N'Mr.', CAST(N'1978-05-29T00:00:00.000' AS DateTime],, CAST(N'2012-01-02T00:00:00.000' AS DateTime],, N'Edgeham Hollow
...
# (8, N'Callahan', N'Laura', N'Inside Sales Coordinator', N'Ms.', CAST(N'1976-01-09T00:00:00.000' AS DateTime],, CAST(N'2012-03-05T00:00:00.000' AS DateTime],, N'4726 - 11th Ave. N.E.', N'Seattle', N'WA', N'98105', N'USA', N'(206], 555-1189', N'2344', N'Laura received a BA in psychology from the University of Washington.  She has also completed a course in business French.  She reads and writes French.', 2, N'http://accweb/emmployees/davolio.bmp'],
...
order_details.each do |order|
  OrderDetail.create!(productID: order[0], unitPrice: order[1], quantity: order[2], discount: order[3])
end 
